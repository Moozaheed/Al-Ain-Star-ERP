...
import {
  ArrowLeft, User, Receipt, FileText, Wallet,
...
type Tab = "overview" | "invoices" | "documents" | "expenses" | "targets";
...
export default function UserDetailPage() {
  ...
  const { user, employee, invoice_stats, recent_invoices, monthly_stats } = data.data;
